 ...
 * @brief Classe ColaboradorController para gerir colaboradores com métodos para adicionar, listar, atualizar e remover, para além de serialização em binário e JSON
 * @date dezembro 2023
 * 
